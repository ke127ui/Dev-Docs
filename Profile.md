![header](https://capsule-render.vercel.app/api?type=waving&color=0:CDF1F2,100:F4D1F5&height=200&text=Profile&fontColor=040B24&fontSize=60&fontAlign=50&fontAlignY=40)
...
하드코딩으로 이루어진 html, scss를 사용하여 장애인 차별 금지법(이하 장차법)을 적용한 병원 99개의 모바일앱 운영을 담당했습니다. 새로운 페이지 구축 퍼블리싱과 유지보수, 개발 작업 시 접근성 관련 업무를 진행하였으며 좀 더 원활한 장차법 ui 마크업을 위하여 업무 관련 컨퍼러스, 교육에 참여하는 등 자기개발에 힘쓸 수 있었습니다. 마이데이터 기반의 과제사업 제출을 위하여 html 표준 마크업을 준수하여 전 페이지 퍼블리싱을 담당하였으며, 해당 작업은 사이트를 참고하여 공부(참고 사이트: [uxkm gulp](https://uxkm.io/buildSystem/gulp/01-gulp_start/01-intro) )하여 gulp + nunjuck를 이용하여 html빌드 후 파일을 전달하는 등 새로운 언어 환경에 적응하고 작업할 수 있는 능력을 다질 수 있었습니다.
